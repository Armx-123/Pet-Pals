...
@client.event
async def on_ready():
    channel = client.get_channel(1287789992063664188)  # Replace CHANNEL_ID with the ID of the channel you want to download attachments from
    await download_attachments(channel,"Data")


client.run('MTIyNzg5NzY2MjU3MzkwMzg3Mg.GVRtbK.YymzvxH7wF4t6yXlK1QFGSAr9vAIHmYSzNDDio')
