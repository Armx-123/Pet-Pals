...
CLIENT_SECRETS_FILE = 'Data/pet.json'
...
def get_authenticated_service():
    ...
    if os.path.exists('Data/pet.pickle'):
        with open('Data/pet.pickle', 'rb') as token_file:
    ...
    if not credentials or not credentials.valid:
        ...
        with open('Data/pet.pickle', 'wb') as token_file:
